...
function App() {
  ...
  if (rol === 'admin') return <AdminPanel onLogout={handleLogout} />;
  if (rol === 'profesor') return <ProfesorPanel onLogout={handleLogout} />;
  if (rol === 'alumno') return <AlumnoPanel onLogout={handleLogout} />;
}
